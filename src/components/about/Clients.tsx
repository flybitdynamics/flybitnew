...
export default function Clients({ onOpenModal }: ClientsProps) {
  ...
  <div className="clients-grid fu">
    ...
    <div className="client-card" onClick={() => openModal(`SciKnowTech`, `Brand launch drone show for SciKnowTech — an education technology company that wanted a high-impact sky debut.`)}><div className="client-name">SciKnowTech</div><div className="client-type">Ed-Tech · Brand Launch</div></div>
    <div className="client-card" onClick={() => openModal(`Gujarat Police`, `FLYBIT displayed the Gujarat Police emblem in the sky — a landmark government show requiring special airspace clearances and precision execution.`)}><div className="client-name">Gujarat Police</div><div className="client-type">Government · Law Enforcement</div></div>
    ...
    <div className="client-card" onClick={() => openModal(`Shreshtha Capital`, `Financial brand launch — growth chart, bar graph, and brand identity written in precision drones above the city skyline.`)}><div className="client-name">Shreshtha Capital</div><div className="client-type">Finance · Brand Launch</div></div>
    ...
    <div className="client-card" onClick={() => openModal(`Wedding Clients — JR & JP`, `FLYBIT has worked with prominent families and wedding planners across India for bespoke wedding drone grand finales.`)}><div className="client-name">JR &amp; JP Families</div><div className="client-type">Social · Wedding</div></div>
    <div className="client-card" onClick={() => openModal(`Government Events`, `Republic Day, Independence Day and cultural tourism shows for state government clients across Rajasthan and Gujarat.`)}><div className="client-name">State Governments</div><div className="client-type">Government · National Events</div></div>
    <div className="client-card" onClick={() => openModal(`Sports &amp; Entertainment`, `Stadium shows, sports brand activations, and opening ceremonies for sports events across India.`)}><div className="client-name">Sports &amp; Entertainment<br />Brands</div><div className="client-type">Sports · Entertainment</div></div>
  </div>
</section>
