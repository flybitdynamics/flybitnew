...
export default function Clients({ onOpenModal }: ClientsProps) {
  ...
  <div className="clients-grid fu">
    ...
    <div className="client-card" onClick={() => openModal(`DGP Cup`, `FLYBIT executed a spectacular drone light show for the DGP Cup, featuring athletic formations, sports animations, and tournament logo reveals in the sky.`)}><div className="client-name">DGP Cup</div><div className="client-type">Sports Tournament</div></div>
  </div>
</section>
