...
export default function CorporateEventsDroneShowPage() {
  return (
    <CategoryLandingPage
      title="Corporate Event Drone Shows"
      keyword="drone show for corporate events"
      eyebrow="Corporate &amp; Business Events"
